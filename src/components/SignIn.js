...
const authURL = "https://accounts.spotify.com/authorize?client_id=bc785a3e64da41a8a122a4458dc4afc3&response_type=token&redirect_uri=http:%2F%2Flocalhost:8080&show_dialog=false&scope=playlist-read-private,playlist-read-collaborative,user-follow-read,user-library-read,user-top-read,user-read-recently-played,user-read-playback-state,user-read-private,ugc-image-upload,playlist-modify-public,playlist-modify-private"
...
const SignIn = () => (
    <div className="main-container">
        <div className="authorise__container">
            ...
            <a href={authURL} className="button">Click here to sign in</a>  
        </div>
    </div>
);
